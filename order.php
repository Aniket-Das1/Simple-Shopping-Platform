        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g. Abcde Jkl" class="input-responsive" required>
            ...
            <?php
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    else
                    {
                        ...
                        $_SESSION['order'] = "<div class='error text-center'>Unable to Order item.</div>";
                        header('location:'.SITEURL);
                    }
